...
const FloatingShape = styled(Box)(({ theme: _ }) => ({
  position: 'absolute',
  borderRadius: '50%',
  opacity: 0.1,
    ...
    <Layout>
      ...
      <Container maxWidth="lg">
        ...
        <Box
          ...
          ref={navRef}
          sx={{ mb: 6, textAlign: 'center', minHeight: '64px' }}
        >
          <Typography
            variant="h2"
            id="cta-title"
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} md={6}>
              <Box
                ...
                sx={{ opacity: introVisible ? 1 : 0, transition: 'opacity 0.6s ease-out' }}
              >
                <Card
                  elevation={2}
                  sx={{
            ...
            <Grid item xs={12} md={6} ref={codeRef}>
              <Box
                ...
                sx={{ opacity: codeVisible ? 1 : 0, transition: 'opacity 0.6s ease-out' }}
              >
                <Card
                  elevation={2}
                  sx={{
