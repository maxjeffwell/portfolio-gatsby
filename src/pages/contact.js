    ...
    <Layout>
      <PageTransition>
        <SEO
          ...
          description="Hire Jeff Maxwell - Full Stack React & Node.js Developer in Orlando, FL. Available for web development projects and JavaScript applications."
          pathname="/contact/"
          keywords={[
          ...
          >
            ...
            <Typography
              ...
              style={{
                fontSize: '1.375rem',
                fontWeight: 400,
                fontFamily: "'AvenirLTStd-Roman', 'AvenirFallback', 'HelveticaNeueLTStd-Roman', 'HelveticaNeueRomanFallback', sans-serif",
                maxWidth: '800px',
                margin: '0 auto',
                lineHeight: 1.5,
                color: 'var(--text-secondary-color)',
